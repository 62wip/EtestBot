        ...
        with self.db.cursor() as cursor:
            try:
                execute_create_all_tables = [
                    ...
                    'CREATE TABLE IF NOT EXISTS `test` (id INT AUTO_INCREMENT PRIMARY KEY, creator_user_id INT, creation_time DATETIME, test_key INT,test_name TEXT, subject_name TEXT, all_questions TEXT, all_answers TEXT, right_answer TEXT, visible_result BIT)'
